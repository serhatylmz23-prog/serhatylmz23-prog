...
* Edit the `Program.cs` source:
  ...
  * Replace `YourServiceEndpoint` with the endpoint for your Speech resource. You can find this endpoint in the Azure Portal under your Speech resource's "Keys and Endpoint" section (e.g., `https://my-speech-resource.cognitiveservices.azure.com`).
