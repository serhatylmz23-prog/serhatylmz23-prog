...
import fetch from 'node-fetch'; // Eğer Node 18+ iseniz global fetch kullanabilir; bu satırı düzenleyin.
...
app.all('/api/cloudflare-proxy/*', async (req, res) => {
  ...
  const pathSuffix = req.path.replace('/api/cloudflare-proxy', '') || '/';
